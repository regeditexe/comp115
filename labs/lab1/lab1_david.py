...
side_1 = 3
side_2 = 4
area = side_1 * side_2  # Calculate the area by multiplying side_1 and side_2
print(f"I think the area of the rectangle is: {area}.") # This line prints the correct area.
...
my_name = "David" # Change to your name
my_github_account = "https://github.com/wdfilter/comp115/tree/main" # Change to your GitHub account
my_hobby = "Skiing & computers" # Change to your hobby
