...
perimeter = 2 * (rectangular_width + rectangular_length)  # modified to calculate perimeter correctly
area = rectangular_width * rectangular_length  # modified to calculate area correctly
...
mark_mid = marks[0]
mark_final = marks[1]
mark_average = (mark_mid + mark_final) / 2  # modified to calculate the grade average correctly
...
#---------------------------------------------------------
increase = 0.2
increase_percentage = increase * 100  # converted the value to a percentage correctly
...
x = 2
count = 0
while count < 8:  # printing the first 8 even natural numbers
    print(x)
    x = x + 2
    count = count + 1
...
# first_even_natural_nums(8) will print the first 8 even natural numbers
# first_even_natural_nums(10) will print the first 10 even natural numbers
